...
object BcSelfGoodsHistory {
  def main(args: Array[String]): Unit = {
   ...
   val salesetdtldf=salesetdtl.map({case(_,result)=>
    ...
    val resultdf=ss.sql("select t2.salesetid,concat(t1.date,t2.salesetdtlid,t2.salesetid,3000) id,3000 as accountid,t2.amount,t2.checkgrossprofit,concat(3000,t1.customerid) customerid,concat(3000,t2.goodsid) goodsid,t2.jobdtlstatus,t2.goodsqty productnumber,t1.sdate,t1.pardate,t2.taxmoney from sale_settle_dtl t2 left join sale_settle t1 on t1.salesetid=t2.salesetid where pardate !='000000'")
