...
public class ModelCubeDayHzInit {
    ...
    //创建model
    public static String createModel(String day) {
        String method = "POST";
        String para = "/models";
        String tableName="SYS_CUSTOMER.SYS_CUS_HZ_"+day;
        String alineName="SYS_CUS_HZ_"+day;
        String modelName="m_hz_day_"+day;
        String joinColum=alineName+".CUSTOMERID";
        String modelDescData ="{\"name\":"    +    "\""+modelName+"\""   +    ",\"owner\": \"ADMIN\",   \"is_draft\": false,   \"description\": \"\",   \"fact_table\": \"SYS_CUSTOMER.SYS_CUSTOMER_SALEFACT\",   \"lookups\": [     {       \"table\":"   +   "\""+tableName+"\""   +   ",       \"kind\": \"LOOKUP\",       \"alias\":"+     "\""+alineName+"\""+     ",       \"join\": {         \"type\": \"inner\",         \"primary_key\": [           "  +  "\""+joinColum+"\""   +   "         ],         \"foreign_key\": [           \"SYS_CUSTOMER_SALEFACT.CUSTOMERID\"         ]       }     },     {       \"table\": \"SYS_CUSTOMER.PCD_GOODS\",       \"kind\": \"LOOKUP\",       \"alias\": \"PCD_GOODS\",       \"join\": {         \"type\": \"inner\",         \"primary_key\": [           \"PCD_GOODS.GOODSID\"         ],         \"foreign_key\": [           \"SYS_CUSTOMER_SALEFACT.GOODSID\"         ]       }     },     {       \"table\": \"SYS_CUSTOMER.SYS_CUSTOMER_BUS\",       \"kind\": \"LOOKUP\",       \"alias\": \"SYS_CUSTOMER_BUS\",       \"join\": {         \"type\": \"inner\",         \"primary_key\": [           \"SYS_CUSTOMER_BUS.ACCOUNTID\"         ],         \"foreign_key\": [           \"SYS_CUSTOMER_SALEFACT.ACCOUNTID\"         ]       }     }   ],   \"dimensions\": [     {       \"table\": \"SYS_CUSTOMER_SALEFACT\",       \"columns\": [         \"SDATE\",         \"ID\",         \"CUSTOMERID\",         \"ACCOUNTID\",         \"GOODSID\",         \"PARDATE\",         \"IS_GIFT\"       ]     },     {       \"table\":" +"\""+alineName+"\""+ ",       \"columns\": [         \"CUSTOMERID\",         \"CREATETIME\",         \"ADDFLAG\",         \"NORFLAG\",         \"DELFLAG\",         \"CUSATTR\",         \"SELFFLAG\",         \"CONSUMLEVEL\",         \"CUSTOMNAME\",         \"CUSTOMTYPE\",         \"ADDRESS\",         \"CONTACTNAME\",         \"PHONENUM\",         \"PROVINCENAME\",         \"LEASTTIME\",         \"CITYNAME\"       ]     },     {       \"table\": \"PCD_GOODS\",       \"columns\": [         \"COMPETENAME\",         \"SHORTNAME\",         \"SHORTVENDOR\",         \"IS_OWN\",         \"VENDOR\",         \"CLASSNAME\",         \"APPROVEDNO\",         \"GOODSID\",         \"GOODSNAME\",         \"STANDSPEC\",         \"UNIT\",         \"FORMULA\"       ]     },     {       \"table\": \"SYS_CUSTOMER_BUS\",       \"columns\": [         \"ACCOUNTID\",         \"BUSINESS_NAME\"       ]     }   ],   \"metrics\": [     \"SYS_CUSTOMER_SALEFACT.PRODUCTNUMBER\",     \"SYS_CUSTOMER_SALEFACT.AMOUNT\"   ],   \"filter_condition\": \"\",   \"partition_desc\": {     \"partition_date_column\": \"SYS_CUSTOMER_SALEFACT.SDATE\",     \"partition_time_column\": null,     \"partition_date_start\": 0,     \"partition_date_format\": \"yyyy-MM-dd\",     \"partition_time_format\": \"HH:mm:ss\",     \"partition_type\": \"APPEND\",     \"partition_condition_builder\": \"org.apache.kylin.metadata.model.PartitionDesc$DefaultPartitionConditionBuilder\"   },   \"capacity\": \"MEDIUM\" }";
    ...
    加载数据
     */
    public static String reloadTable(String yesToday){
        String method="POST";
        String para="/tables/sys_customer.sys_customer_salefact,sys_customer.sys_cus_hz_"+yesToday +",/sys_customer";
