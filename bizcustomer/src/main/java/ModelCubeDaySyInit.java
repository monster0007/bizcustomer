...
public class ModelCubeDaySyInit {
    ...
    public static String createCube(String day) {
        String modelName="m_sy_day_"+day;
        String method = "POST";
        String para = "/cubes";
        String cubeName="c_sy_day_"+day;
        String tableName="sys_cus_sy_"+day;
    ...
    public static String createModel(String day) {
        String method = "POST";
        String para = "/models";
        String tableName="sys_customer.sys_cus_sy_"+day;
        String alineName="sys_cus_sy_"+day;
        String modelName="m_sy_day_"+day;
    ...
    public static String reloadTable(String yesToday){
        String method="POST";
        String para="/tables/sys_customer.sys_customer_salefact,sys_customer.sys_cus_sy_"+yesToday +",/sys_customer";
