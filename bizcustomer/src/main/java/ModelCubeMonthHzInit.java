 ...
 *
 */
public class ModelCubeMonthHzInit {
    ...
    public static String createModel(String month) {
        ...
        String modelName="m_hz_month_"+month;
    ...
    public static String createCube(String month) {
        ...
        String method = "POST";
        String para = "/cubes";
        String cubeName="c_hz_month_"+month;
        String tableName="sys_cus_hz_"+month;
        // cube 信息
    ...
    public static String reloadTable(String month){
        ...
        String body="{" + "\"tableData\":" + "\"" + tableData + "\"" +
                ",\"project\" :  \"sys_customer\"" +
                "}";
        System.out.println("tablename:" + "sys_cus_hz_" + month);
        return excute(para,method,body);
    }
